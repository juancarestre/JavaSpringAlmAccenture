...
public class LogicaNegocioProductoImp implements LogicaNegocioProducto  {
	...
	public static final String MENSAJE_NO_CANTIDAD = "La cantidad del producto no es válida";
	...
	public static final String MENSAJE_NO_PRECIO = "El precio del producto no es válido";
